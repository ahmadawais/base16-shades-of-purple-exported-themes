...
local base06 = "#ff77ff" -- +++
local base07 = "#ffffff" -- ++++
local base08 = "#d90429" -- red
local base09 = "#f92a1c" -- orange
local base0A = "#ffe700" -- yellow
local base0B = "#3ad900" -- green
local base0C = "#00c5c7" -- aqua/cyan
local base0D = "#6943ff" -- blue
local base0E = "#ff2c70" -- purple
local base0F = "#79e8fb" -- brown
